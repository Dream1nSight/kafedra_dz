...
--типы под заголовки
create or replace type KOTLYAROV_DM.t_fetch_header as object (
    name varchar2(50),
    value varchar2(100)
);

create or replace type KOTLYAROV_DM.t_arr_fetch_header as table of KOTLYAROV_DM.t_fetch_header;

create or replace function KOTLYAROV_DM.http_fetch
(
    ...
    p_headers KOTLYAROV_DM.t_arr_fetch_header default null, --заголовки запроса
...
begin
    ...
    loop
    declare
        v_header KOTLYAROV_DM.t_fetch_header := p_headers(i);
    begin
